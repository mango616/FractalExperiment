...
public class Raymarcher : MonoBehaviour
{
    ...
    public int m_scene;
	[Range(0.0f, 1.0f)]
	public float c_size_x;
	[Range(0.0f, 1.0f)]
	public float c_size_y;
	[Range(0.0f, 1.0f)]
	public float c_size_z;
	[Range(0.0f, 1.0f)]
	public float c_size;
    ...
    void UpdateMaterial()
    {
        ...
        if (!m_screen_space)
        {
			...
			m_internal_material.SetVector ("_CSize", new Vector3 (c_size_x, c_size_y, c_size_z));
			m_internal_material.SetFloat ("_Size", c_size);
        }
    }
